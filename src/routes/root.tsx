    ...
    <div className='flex flex-col items-center justify-evenly bg-blue-300 min-h-screen'>
      <div className='flex flex-col items-center'>
        ...
        <div className='text-3xl'>
          <p>
            Learn
            <a href='https://gitmoji.dev/' className='text-red-500 no-underline'>
              gitmoji!
            </a>
          </p>
        </div>
      ...
      <div>
        <a
          href='https://github.com/ImBIOS/gitmemoji'
          className='bg-yellow-900 text-white shadow-md inline-block cursor-pointer rounded-lg font-semibold py-3 px-4 hover:shadow-lg hover:shadow-white hover:translate-y-0.5'
        >
